...
from config import DURATION_LIMIT, UPDATES_CHANNEL, BOT_USERNAME
...
async def play(_, message: Message):
    ...
    if audio:
        ...
        title = file_name
        thumb_name = "https://telegra.ph//file/bea6786317c0d11486e1d.jpg"
        ...
        [
            [
                InlineKeyboardButton("📚 Bilgi", url=f"https://t.me/{BOT_USERNAME}"),
            ...
            title = "NaN"
            thumb_name = "https://te.legra.ph/file/9491ae179899eae7556b1.jpg"
            duration = "NaN"
            views = "NaN"
            keyboard = InlineKeyboardMarkup(
                    [
